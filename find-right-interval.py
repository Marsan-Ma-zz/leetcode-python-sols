...
# interval j whose start point is bigger than or equal to the end point of the interval i, 
...
class Solution(object):
    def findRightInterval(self, intervals):
        ...
        points = sorted([(t.start, i) for i, t in enumerate(intervals)])
        ...
        for t in intervals:
            if t.end > points[-1][0]:
                ...
                idx = bisect_left(points, (t.end, 0))
                sols.append(points[idx][1])
        return sols
